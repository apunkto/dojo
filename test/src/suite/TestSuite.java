...
public class TestSuite {
  ...
  public void maxFromFile() throws IOException {
    Assert.assertEquals(birth2, DojoSolver.maxFromFile("births.dat", FileType.BIRTH));
    Assert.assertEquals(soccer1, DojoSolver.maxFromFile("soccer.dat", FileType.SOCCER));
  }
